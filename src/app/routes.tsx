...
export function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="/productos/finanzas" element={<ExternalRedirect to="https://finanzas.zemyx.com" />} />
      <Route path="/productos/gastos" element={<ExternalRedirect to="https://finanzas.zemyx.com" />} />
